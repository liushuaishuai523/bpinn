...
parser.add_argument('--filename', type=str, default='1-BPINN_0dot925_0dot1_8_5_3', help='保存数据文件名')
...
def train(model_1):
    ...
    for epoch in range(args.e):
        def closure():
            ...
            # 组合损失
            loss = args.w_pde * pde_loss_1 + args.w_bc * (bc_loss_1+bc_loss_u_xx) + args.w_g * loss_g + args.w_ini * loss_ini + args.w_time * loss_time
