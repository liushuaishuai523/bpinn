...
parser.add_argument('--ranges', type=list, default=[[-1, 1], [0, 0.1663]], help='空间，时间范围')
...
parser.add_argument('--filename', type=str, default='4-A-BPINN_0dot1663_0dot1_8_5_2', help='保存数据文件名')
...
def Operator(U, gU, X, domain):
    ...
    if domain == 'domain_1':
        output = delta + U_xx / torch.exp(U) + gU_t  # 格式2
    else:
